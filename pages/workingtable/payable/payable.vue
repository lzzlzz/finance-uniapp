<template>
	<view>
		...
		<view class="headline"><text class="cuIcon-titles text-orange"></text>应付账款明细</view>
					...
					<view class="uni-collapse-cell__title" @click="getDetail(oitem)">
						<view class="uni-collapse-cell__title-inner">
							<view class="uni-collapse-cell__title-text row">
								...
								<view class="col1">
									<view class="text-gray">贷方余额 :<text class="td">{{ oitem.totalAmount|priceFormat(2,'￥',true)}}</text></view>
								</view>
							</view>
						</view>
					</view>
	...
	export default {
		...
		methods: {
			...
			getData(){
				...
				ageAnalysisRpt.reportName = 'GL_SupplierAgeAnalysisSumRpt';
